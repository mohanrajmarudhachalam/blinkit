...
function CartBeforeCheckout(props: dealsofDay) {
        ...
        <View style={styles.main_container}>
            ...
            <View style={{ flexDirection: 'column' }}>
                <Svg width="29" height="29" viewBox="0 0 29 29" fill="none" style={{ alignSelf: 'flex-end', marginRight: 15, marginTop: 5 }}>
                    ...
                    />
                    <View>
                        <Text style={styles.discount_text}>{offerDetails}{'%'}{'\n'}off</Text>
                    </View>
                </Svg>
                <DealsIcon imageSource={deals_image} />
                <Text style={styles.nameText}>{name}</Text>
                <Text style={styles.count_text}>{counts}</Text>
            </View>
            <View style={styles.price_container}>
                    <Text style={styles.new_price_text}>${newprice}</Text>
                    <Text style={styles.money_symbol_text}>$</Text>
                    <Text style={styles.old_price_text}>{oldprice}</Text>
                <View style={styles.CircleShape}>
                    <Text style={styles.plus_symbol_text}>+</Text>
                </View>
            </View>
